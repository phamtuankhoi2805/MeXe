...
public class AddressController {
     ...
     * Sắp xếp theo địa chỉ mặc định trước (default = true), sau đó mới đến các địa
     * chỉ khác
     * 
     ...
     * 
     * 
     * @param request Chứa: userId, fullName, phone, province, district, ward,
     *                street
     ...
     * Nếu xóa địa chỉ mặc định, hệ thống sẽ tự động đặt một địa chỉ khác làm mặc
     * định
     * 
